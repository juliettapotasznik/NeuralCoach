...
class InferenceEngine:
    def __init__(self, model_path, device, stride):
        print("InferenceEngine: init start", file=sys.stderr)
        self.device = device
        self.stride = stride
        ...
        print("InferenceEngine: after model read", file=sys.stderr)
        print("Model outputs:", [o.get_any_name() for o in self.model.outputs], file=sys.stderr)
        ...
        print("InferenceEngine: after compile_model", file=sys.stderr)
